...
export default function Newsletter () {
    ...
    return (
        <div id="Newsletter" className="h-full">
            ...
            <div>
                ...
                >
                    ...
                    <div className="pt-64">
                        <input className="bg-white  text-black text-3xl md:text-6xl pl-8 placeholder-gray-700 outline-none placeholder-opacity-90"
                            type="email" 
                            name="user_email" 
                            id="email"  
